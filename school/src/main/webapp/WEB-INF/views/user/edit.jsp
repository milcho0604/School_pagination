...
<div class="container">
  <form:form method="post" modelAttribute="user">
    <div class="title">정보 ${ user.id > 0 ? "수정" : "등록" }</div>
    <table>
      <tr>
        <td>로그인 번호:</td>
      ...
      <tr>
        <td>구성타입:</td>
        <td><form:radiobutton path="userType" value="관리자" label="관리자" />
            <form:radiobutton path="userType" value="교수" label="교수" />
            <form:radiobutton path="userType" value="학생" label="학생" />
        </td>
